...
<head>
	...
	<title>DENR | Tree cut permit</title>
...
<body>
	...
	<div id="flipbook">
		<div>
			<img width="100%" height="100%" src="../images/frontpage/Tree Cutting Permit for DPWH.jpg">
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img  width="100%" height="100%" src="../images/TCP/step1.jpg">
		</div>

		<div>
			<img src="../images/TCP/step2.jpg"alt="" width="100%" height="100%">
		</div>
 
		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/TCP/step3.jpg" alt="" width="100%" height="100%" >
		</div>

		<div>
			<img src="../images/TCP/step4.jpg" alt="" width="100%" height="100%" >
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/TCP/step5.jpg" alt="" width="100%" height="100%" >
		</div>

		<div>
			<img src="../images/TCP/step6.jpg" alt="" width="100%" height="100%">
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/TCP/step7.jpg" alt="" width="100%" height="100%" >
        </div>
        <div>
			<img src="../images/TCP/step8.jpg" alt="" width="100%" height="100%">
        </div>
        <div style="border-right:2px solid #5f9ea0;">
			<img src="../images/TCP/step9.jpg" alt="" width="100%" height="100%" >
        </div>
        <div>
			<img src=../images/TCP/step10.jpg alt="" width="100%" height="100%">
        </div>
        <div style="border-right:2px solid #5f9ea0;">
			<img src="../images/TCP/step11.jpg" alt="" width="100%" height="100%" >
        </div>
        <div>
			<img src=../images/TCP/step12.jpg alt="" width="100%" height="100%">
        </div>
        <div style="border-right:2px solid #5f9ea0;">
			<img src="../images/TCP/step13.jpg" alt="" width="100%" height="100%">
        </div>
        <div>
			<img src="../images/TCP/step14.jpg" alt="" width="100%" height="100%">
        </div>
        <div>
