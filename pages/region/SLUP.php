...
<body>
	...
	<div id="flipbook">
		<div>
			<img width="100%" height="100%" src="../images/frontpage/SpecialLandUsePermit.jpg">
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img  width="100%" height="100%" src="../images/SLUP/step1.jpg">
		</div>

		<div>
			<img src="../images/SLUP/step2.jpg"alt="" width="100%" height="100%">
		</div>
 
		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/SLUP/step3.jpg" alt="" width="100%" height="100%">
		</div>

		<div>
			<img src="../images/SLUP/step4.jpg" alt="" width="100%" height="100%" >
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/SLUP/step5.jpg" alt="" width="100%" height="100%">
		</div>

		<div>
			<img src="../images/SLUP/step6.jpg" alt="" width="100%" height="100%">
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/SLUP/step7.jpg" alt="" width="100%" height="100%">
        </div>
        <div>
			<img src="../images/SLUP/step8.jpg" alt="" width="100%" height="100%">
        </div>
        <div style="border-right:2px solid #5f9ea0;">
			<img src="../images/SLUP/step9.jpg" alt="" width="100%" height="100%">
        </div>
        <div>
			<img src="../images/SLUP/step10.jpg" alt="" width="100%" height="100%">
        </div>
        <div style="border-right:2px solid #5f9ea0;">
			<img src="../images/SLUP/step11.jpg" alt="" width="100%" height="100%">
        </div>
        <div>
			<img src="../images/SLUP/step12.jpg" alt="" width="100%" height="100%">
        </div>
        <div>
