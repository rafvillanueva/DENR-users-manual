...
<body>
	...
	<div id="flipbook">
		<div>
			<img width="100%" height="100%" src="../images/frontpage/ViewSummaryReport.jpg">
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img  width="100%" height="100%"  src="../images/VSR/vs1.jpg">
		</div>

		<div>
			<img src="../images/VSR/vs2.jpg"alt="" width="100%" height="100%">
		</div>
