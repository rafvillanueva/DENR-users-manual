...
<head>
	...
	<title>DENR | Certificate of Wild life registration</title>
...
<body>
	...
	<div id="flipbook">
		<div>
			<img width="100%" height="100%" src="../images/frontpage/CerofWildlifeRegistration.jpg">
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img  width="100%" height="100%"  src="../images/CWR/step1.jpg">
		</div>

		<div>
			<img src="../images/CWR/step2.jpg"alt="" width="100%" height="100%">
		</div>
 
		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/CWR/step3.jpg" alt="" width="100%" height="100%" >
		</div>

		<div>
			<img src="../images/CWR/step4.jpg" alt="" width="100%" height="100%" >
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/CWR/step5.jpg" alt="" width="100%" height="100%" >
		</div>

		<div>
			<img src="../images/CWR/step6.jpg" alt="" width="100%" height="100%">
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/CWR/step7.jpg" alt="" width="100%" height="100%" >
        </div>
        <div>
			<img src="../images/CWR/step8.jpg" alt="" width="100%" height="100%">
        </div>
        <div style="border-right:2px solid #5f9ea0;">
			<img src=../images/CWR/step9.jpg alt="" width="100%" height="100%" >
        </div>
        <div>
			<img src="../images/CWR/step10.jpg" alt="" width="100%" height="100%">
        </div>
        <div>
