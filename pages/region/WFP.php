...
<body>
  ...
  </div><script src="../../Bootstrap_Files/libs/bootstrap/js/html5shiv.min.js"></script>
	...
	<div id="flipbook">
		<div>
			<img width="100%" height="100%" src="../images/frontpage/WildLifeFarmPermit.jpg">
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img  width="100%" height="100%" src="../images/WFP/step1.jpg">
		</div>

		<div>
			<img src="../images/WFP/step2.jpg"alt="" width="100%" height="100%">
		</div>
 
		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/WFP/step3.jpg" alt="" width="100%" height="100%" >
		</div>

		<div>
			<img src="../images/WFP/step4.jpg" alt="" width="100%" height="100%" >
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/WFP/step5.jpg" alt="" width="100%" height="100%" >
		</div>

		<div>
			<img src="../images/WFP/step6.jpg" alt="" width="100%" height="100%">
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/WFP/step7.jpg" alt="" width="100%" height="100%" >
        </div>
        <div>
			<img src="../images/WFP/step8.jpg" alt="" width="100%" height="100%">
        </div>
        <div style="border-right:2px solid #5f9ea0;">
			<img src=../images/WFP/step9.jpg alt="" width="100%" height="100%" >
        </div>
        <div>
			<img src=../images/WFP/step10.jpg alt="" width="100%" height="100%">
        </div>
        <div style="border-right:2px solid #5f9ea0;">
			<img src="../images/WFP/step11.jpg" alt="" width="100%" height="100%"> 
        </div>
        <div>
			<img src="../images/WFP/step12.jpg" alt="" width="100%" height="100%">
        </div>
        <div>
