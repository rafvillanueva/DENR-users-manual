...
<head>
	...
	<title>DENR | CORlogrenewal</title>
...
<body>
	...
	<div id="flipbook">
		<div>
			<img width="100%" height="100%" src="../images/frontpage/CoR(LogLumber).jpg">
		</div>
		...
		<div>
			<img src="../images/COR(agent contractor etc)/step2.jpg"alt="" width="100%" height="100%">
		</div>
 
		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/COR(agent contractor etc)/step3.jpg" alt="" width="100%" height="100%" >
		</div>

		<div>
			<img src="../images/COR(agent contractor etc)/step4.jpg" alt="" width="100%" height="100%" >
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/COR(agent contractor etc)/step5.jpg" alt="" width="100%" height="100%" >
		</div>

		<div>
			<img src="../images/COR(agent contractor etc)/step6.jpg" alt="" width="100%" height="100%">
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/COR(agent contractor etc)/step7.jpg" alt="" width="100%" height="100%" >
        </div>
        <div>
			<img src="../images/COR(agent contractor etc)/step8.jpg" alt="" width="100%" height="100%">
        </div>
        <div style="border-right:2px solid #5f9ea0;">
			<img src="../images/COR(agent contractor etc)/step9.jpg" alt="" width="100%" height="100%" >
        </div>
        <div>
			<img src="../images/COR(agent contractor etc)/step10.jpg" alt="" width="100%" height="100%">
        </div>
        <div style="border-right:2px solid #5f9ea0;">
			<img src="../images/COR(agent contractor etc)/step11.jpg" alt="" width="100%" height="100%" >
        </div>
        <div>
			<img src="../images/COR(agent contractor etc)/step12.jpg" alt="" width="100%" height="100%">
        </div>
        <div style="border-right:2px solid #5f9ea0;">
			<img src="../images/COR(agent contractor etc)/step13.jpg" alt="" width="100%" height="100%">
        </div>
        <div>
			<img src=images/15.jpg alt="" width="100%" height="100%">
        </div>
        <div>
