...
<body>
	...
	<div id="flipbook">
		<div>
			<img width="100%" height="100%" src="../images/frontpage/ProvisionalPermit.jpg">
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img  width="100%" height="100%"src="../images/PP/step1.jpg">
		</div>

		<div>
			<img src="../images/PP/step2.jpg"alt="" width="100%" height="100%">
		</div>
 
		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/PP/step3.jpg" alt="" width="100%" height="100%" >
		</div>

		<div>
			<img src="../images/PP/step4.jpg" alt="" width="100%" height="100%" >
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/PP/step5.jpg" alt="" width="100%" height="100%" >
		</div>

		<div>
			<img src=../images/PP/step6.jpg alt="" width="100%" height="100%">
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img src=../images/PP/step7.jpg alt="" width="100%" height="100%" >
        </div>
        <div>
			<img src=../images/PP/step8.jpg alt="" width="100%" height="100%">
        </div>
        <div style="border-right:2px solid #5f9ea0;">
			<img src=../images/PP/step9.jpg alt="" width="100%" height="100%" >
        </div>
        <div>
			<img src="../images/PP/step10.jpg" alt="" width="100%" height="100%">
        </div>
        <div style="border-right:2px solid #5f9ea0;">
			<img src="../images/PP/step11.jpg" alt="" width="100%" height="100%" >
        </div>
        <div>
