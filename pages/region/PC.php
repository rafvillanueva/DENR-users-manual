...
<head>
	...
	<title>DENR | Permit to Cut</title>
...
<body>
	...
	<div id="flipbook">
		<div>
			<img width="100%" height="100%" src="../images/frontpage/Permit to CutHarvest.jpg">
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img  width="100%" height="100%"  src="../images/PC/step1.jpg">
		</div>

		<div>
			<img src="../images/PC/step2.jpg"alt="" width="100%" height="100%">
		</div>
 
		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/PC/step3.jpg" alt="" width="100%" height="100%">
		</div>

		<div>
			<img src="../images/PC/step4.jpg" alt="" width="100%" height="100%" >
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/PC/step5.jpg" alt="" width="100%" height="100%">
		</div>

		<div>
			<img src="../images/PC/step6.jpg" alt="" width="100%" height="100%">
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/PC/step7.jpg" alt="" width="100%" height="100%">
        </div>
        <div>
			<img src="../images/PC/step8.jpg" alt="" width="100%" height="100%">
        </div>
        <div style="border-right:2px solid #5f9ea0;">
			<img src="../images/PC/step9.jpg" alt="" width="100%" height="100%">
        </div>
        <div>
			<img src="../images/PC/step10.jpg" alt="" width="100%" height="100%">
        </div>
        <div style="border-right:2px solid #5f9ea0;">
			<img src="../images/PC/step11.jpg" alt="" width="100%" height="100%">
        </div>
        <div>
