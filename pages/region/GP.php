...
<body>
	...
	<div id="flipbook">
		<div>
			<img width="100%" height="100%" src="../images/frontpage/GratuitosPermit.jpg">
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img  width="100%" height="100%"  src="../images/GP/step1.jpg">
		</div>

		<div>
			<img src="../images/GP/step2.jpg"alt="" width="100%" height="100%">
		</div>
 
		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/GP/step3.jpg" alt="" width="100%" height="100%" >
		</div>

		<div>
			<img src="../images/GP/step4.jpg" alt="" width="100%" height="100%" >
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/GP/step5.jpg" alt="" width="100%" height="100%" >
		</div>

		<div>
			<img src="../images/GP/step6.jpg" alt="" width="100%" height="100%">
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/GP/step7.jpg" alt="" width="100%" height="100%" >
        </div>
        <div>
			<img src="../images/GP/step8.jpg" alt="" width="100%" height="100%">
        </div>
        <div style="border-right:2px solid #5f9ea0;">
			<img src="../images/GP/step9.jpg" alt="" width="100%" height="100%" >
        </div>
        <div>
			<img src="../images/GP/step10.jpg" alt="" width="100%" height="100%">
        </div>
        <div style="border-right:2px solid #5f9ea0;">
			<img src="../images/GP/step11.jpg" alt="" width="100%" height="100%" >
        </div>
        <div>
