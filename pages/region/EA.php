...
<div class="menu-wrap">
	...
	<div id="flipbook">
		<div>
			<img width="100%" height="100%" src="../images/frontpage/ExportAuthority.jpg">
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img  width="100%" height="100%"  src="../images/Export/step1.jpg">
		</div>

		<div>
			<img src="../images/Export/step2.jpg"alt="" width="100%" height="100%">
		</div>
 
		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/Export/step3.jpg" alt="" width="100%" height="100%" >
		</div>

		<div>
			<img src="../images/Export/step4.jpg" alt="" width="100%" height="100%" >
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/Export/step5.jpg" alt="" width="100%" height="100%" >
		</div>

		<div>
			<img src="../images/Export/step6.jpg" alt="" width="100%" height="100%">
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/Export/step7.jpg" alt="" width="100%" height="100%" >
        </div>
        <div>
			<img src="../images/Export/step8.jpg" alt="" width="100%" height="100%">
        </div>
        <div style="border-right:2px solid #5f9ea0;">
			<img src="../images/Export/step9.jpg" alt="" width="100%" height="100%" >
        </div>
        <div>
			<img src="../images/Export/step10.jpg" alt="" width="100%" height="100%">
        </div>
        <div style="border-right:2px solid #5f9ea0;">
			<img src="../images/Export/step11.jpg" alt="" width="100%" height="100%" >
        </div>
        <div>
			<img src="../images/Export/step12.jpg" alt="" width="100%" height="100%">
        </div>
        <div>
