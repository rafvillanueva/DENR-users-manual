...
<body>
	...
	<div id="flipbook">
		<div>
			<img width="100%" height="100%" src="../images/frontpage/Request for Clearance to Cut.jpg">
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img  width="100%" height="100%" src="../images/RFC/step1.jpg">
		</div>

		<div>
			<img src="../images/RFC/step2.jpg"alt="" width="100%" height="100%">
		</div>
 
		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/RFC/step3.jpg" alt="" width="100%" height="100%">
		</div>

		<div>
			<img src="../images/RFC/step4.jpg" alt="" width="100%" height="100%" >
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/RFC/step5.jpg" alt="" width="100%" height="100%">
		</div>

		<div>
			<img src=images/7.jpg alt="" width="100%" height="100%">
		</div>
