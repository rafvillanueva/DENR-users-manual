...
<body>
	...
	<div id="flipbook">
		<div>
			<img width="100%" height="100%" src="../images/frontpage/Certification for Water Permit.jpg">
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img  width="100%" height="100%"src="../images/CWPA/step1.jpg">
		</div>

		<div>
			<img src="../images/CWPA/step2.jpg"alt="" width="100%" height="100%">
		</div>
 
		<div style="border-right:2px solid #5f9ea0;">
			<img src=../images/CWPA/step3.jpg alt="" width="100%" height="100%" >
		</div>

		<div>
			<img src=../images/CWPA/step4.jpg alt="" width="100%" height="100%" >
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img src=../images/CWPA/step5.jpg alt="" width="100%" height="100%" >
		</div>

		<div>
			<img src=../images/CWPA/step6.jpg alt="" width="100%" height="100%">
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img src=../images/CWPA/step7.jpg alt="" width="100%" height="100%" >
        </div>
        <div>
			<img src=../images/CWPA/step8.jpg alt="" width="100%" height="100%">
        </div>
        <div style="border-right:2px solid #5f9ea0;">
			<img src=../images/CWPA/step9.jpg alt="" width="100%" height="100%" >
        </div>
        <div>
			<img src=images/11.jpg alt="" width="100%" height="100%">
        </div>
         <div>
