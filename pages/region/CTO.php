...
<body>
	...
	<div id="flipbook">
		<div>
			<img width="100%" height="100%" src="../images/frontpage/ClearanceToOperate.jpg">
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img  width="100%" height="100%" src="../images/CTO/step1.jpg">
		</div>

		<div>
			<img src="../images/CTO/step2.jpg"alt="" width="100%" height="100%">
		</div>
 
		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/CTO/step3.jpg" alt="" width="100%" height="100%" >
		</div>

		<div>
			<img src="../images/CTO/step4.jpg" alt="" width="100%" height="100%" >
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/CTO/step5.jpg" alt="" width="100%" height="100%" >
		</div>

		<div>
			<img src="../images/CTO/step6.jpg" alt="" width="100%" height="100%">
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/CTO/step7.jpg" alt="" width="100%" height="100%" >
        </div>
        <div>
			<img src="../images/CTO/step8.jpg" alt="" width="100%" height="100%">
        </div>
        <div style="border-right:2px solid #5f9ea0;">
			<img src="../images/CTO/step9.jpg" alt="" width="100%" height="100%" >
        </div>
        <div>
			<img src="../images/CTO/step10.jpg" alt="" width="100%" height="100%">
        </div>
        <div>
