...
<body>
	...
	<div id="flipbook">
		<div>
			<img width="100%" height="100%" src="../images/frontpage/RequestforAuthorutytoProcessMilll.jpg">
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img  width="100%" height="100%"  src="../images/RAP/step1.jpg">
		</div>

		<div>
			<img src="../images/RAP/step2.jpg"alt="" width="100%" height="100%">
		</div>
 
		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/RAP/step3.jpg" alt="" width="100%" height="100%" >
		</div>

		<div>
			<img src="../images/RAP/step4.jpg" alt="" width="100%" height="100%" >
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/RAP/step5.jpg" alt="" width="100%" height="100%" >
		</div>

		<div>
			<img src="../images/RAP/step6.jpg" alt="" width="100%" height="100%">
		</div>

		<div style="border-right:2px solid #5f9ea0;"	>
			<img src="../images/RAP/step7.jpg" alt="" width="100%" height="100%" >
        </div>
        <div>
			<img src="../images/RAP/step8.jpg" alt="" width="100%" height="100%">
        </div>
        <div>
