...
<body>
	...
	<div id="flipbook">
		<div>
			<img width="100%" height="100%" src="../images/frontpage/Wildlife Special UsePermit.jpg">
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img  width="100%" height="100%" src="../images/WSUP/step1.jpg">
		</div>

		<div>
			<img src="../images/WSUP/step2.jpg"alt="" width="100%" height="100%">
		</div>
 
		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/WSUP/step3.jpg" alt="" width="100%" height="100%" >
		</div>

		<div>
			<img src="../images/WSUP/step4.jpg" alt="" width="100%" height="100%" >
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/WSUP/step5.jpg" alt="" width="100%" height="100%" >
		</div>

		<div>
			<img src="../images/WSUP/step6.jpg" alt="" width="100%" height="100%">
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/WSUP/step7.jpg" alt="" width="100%" height="100%" >
        </div>
        <div>
			<img src="../images/WSUP/step8.jpg" alt="" width="100%" height="100%">
        </div>
        <div style="border-right:2px solid #5f9ea0;">
			<img src="../images/WSUP/step9.jpg" alt="" width="100%" height="100%" >
        </div>
        <div>
			<img src=../images/WSUP/step10.jpg alt="" width="100%" height="100%">
        </div>
        <div style="border-right:2px solid #5f9ea0;">
			<img src="../images/WSUP/step11.jpg" alt="" width="100%" height="100%" >
        </div>
        <div>
			<img src=images/submitted.jpg alt="" width="100%" height="100%">
        </div>
        <div>
