...
<body>
	...
	<div id="flipbook">
		<div>
			<img width="100%" height="100%" src="../images/frontpage/WildlifeExportCertification.jpg">
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img  width="100%" height="100%" src="../images/WEC/step1.jpg">
		</div>

		<div>
			<img src="../images/WEC/step2.jpg"alt="" width="100%" height="100%">
		</div>
 
		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/WEC/step3.jpg" alt="" width="100%" height="100%" >
		</div>

		<div>
			<img src="../images/WEC/step4.jpg" alt="" width="100%" height="100%" >
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/WEC/step5.jpg" alt="" width="100%" height="100%">
		</div>

		<div>
			<img src="../images/WEC/step6.jpg" alt="" width="100%" height="100%">
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/WEC/step7.jpg" alt="" width="100%" height="100%">
        </div>
        <div>
			<img src="../images/WEC/step8.jpg" alt="" width="100%" height="100%">
        </div>
        <div style="border-right:2px solid #5f9ea0;">
			<img src="../images/WEC/step9.jpg" alt="" width="100%" height="100%">
        </div>
        <div>
			<img src=../images/WEC/step10.jpg alt="" width="100%" height="100%">
        </div>
        <div style="border-right:2px solid #5f9ea0;">
			<img src=../images/WEC/step11.jpg alt="" width="100%" height="100%">
        </div>
        <div>
