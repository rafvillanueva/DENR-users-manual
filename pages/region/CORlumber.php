...
<body>
	...
	<div id="flipbook">
		<div>
			<img width="100%" height="100%" src="../images/frontpage/CoRLumberDealer.jpg">
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img  width="100%" height="100%"  src="../images/COR(lumber)/step1.jpg">
		</div>

		<div>
			<img src="../images/COR(lumber)/step2.jpg"alt="" width="100%" height="100%">
		</div>
 
		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/COR(lumber)/step3.jpg"alt="" width="100%" height="100%" >
		</div>

		<div>
			<img src="../images/COR(lumber)/step4.jpg" alt="" width="100%" height="100%" >
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/COR(lumber)/step5.jpg" alt="" width="100%" height="100%" >
		</div>

		<div>
			<img src="../images/COR(lumber)/step6.jpg" alt="" width="100%" height="100%">
		</div>

		<div style="border-right:2px solid #5f9ea0;">
			<img src="../images/COR(lumber)/step7.jpg" alt="" width="100%" height="100%" >
        </div>
        <div>
			<img src="../images/COR(lumber)/step8.jpg" alt="" width="100%" height="100%">
        </div>
        <div style="border-right:2px solid #5f9ea0;">
			<img src="../images/COR(lumber)/step9.jpg" alt="" width="100%" height="100%" >
        </div>
        <div>
			<img src="../images/COR(lumber)/step10.jpg" alt="" width="100%" height="100%">
        </div>
        <div style="border-right:2px solid #5f9ea0;">
			<img src="../images/COR(lumber)/step11.jpg" alt="" width="100%" height="100%" >
        </div>
        <div>
			<img src="../images/COR(lumber)/step12.jpg" alt="" width="100%" height="100%">
        </div>
        <div>
